...
execute if score @a[tag=elim_target] role matches 1..2 run tellraw @a {"translate":"syb.chat.elim_player.done","with":[{"selector":"@a[tag=pres]"},{"selector":"@a[tag=elim_target]"}]}
execute if score @a[tag=elim_target] role matches 3 run tellraw @a {"translate":"syb.chat.elim_player.win","with":[{"selector":"@a[tag=pres]"},{"selector":"@a[tag=elim_target]"}]}
...
execute if score @a[tag=elim_target] role matches 1..2 run schedule function syb:election/trigger/new_pres 2s
execute if score @a[tag=elim_target] role matches 3 run schedule function syb:game/trigger/end/villager_win 2s