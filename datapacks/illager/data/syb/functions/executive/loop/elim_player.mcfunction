execute as @a[tag=pres,scores={used_coas=1..}] if data entity @s SelectedItem{id:"minecraft:player_head"} run function syb:executive/trigger/end/elim_player

execute if score time_seconds math matches 0 run function syb:executive/trigger/end/elim_player
...
execute store result bossbar syb:elim_player value run scoreboard players get phase_time game_data

bossbar set syb:elim_player name {"translate":"syb.bossbar.elim_player.alt","color":"dark_aqua","with":[{"score":{"name":"min_below_10","objective":"math"}},{"score":{"name":"time_minutes","objective":"math"}},{"score":{"name":"sec_below_10","objective":"math"}},{"score":{"name":"time_seconds","objective":"math"}}]}
bossbar set syb:elim_player name {"translate":"syb.bossbar.elim_player","color":"dark_aqua","with":[{"score":{"name":"min_below_10","objective":"math"}},{"score":{"name":"time_minutes","objective":"math"}},{"score":{"name":"sec_below_10","objective":"math"}},{"score":{"name":"time_seconds","objective":"math"}}]}