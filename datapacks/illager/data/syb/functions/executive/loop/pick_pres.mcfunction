execute if entity @s[tag=pres,scores={used_coas=1..}] run function syb:executive/end/pick_pres

execute if score time_seconds math matches 0 run function syb:executive/end/pick_pres
