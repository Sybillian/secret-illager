execute if entity @s[tag=pres,scores={used_coas=1..}] run function syb:executive/end/investigate

execute if score time_seconds math matches 0 run function syb:executive/end/investigate
...
execute store result bossbar syb:investigate value run scoreboard players get phase_time game_data

bossbar set syb:investigate name {"translate":"syb.bossbar.investigate.alt","color":"dark_aqua","with":[{"score":{"name":"min_below_10","objective":"math"}},{"score":{"name":"time_minutes","objective":"math"}},{"score":{"name":"sec_below_10","objective":"math"}},{"score":{"name":"time_seconds","objective":"math"}}]}
bossbar set syb:investigate name {"translate":"syb.bossbar.investigate","color":"dark_aqua","with":[{"score":{"name":"min_below_10","objective":"math"}},{"score":{"name":"time_minutes","objective":"math"}},{"score":{"name":"sec_below_10","objective":"math"}},{"score":{"name":"time_seconds","objective":"math"}}]}