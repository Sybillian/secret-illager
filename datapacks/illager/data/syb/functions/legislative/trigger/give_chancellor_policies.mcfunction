...
execute if score v_policies_inhand game_data matches 1 run give @a[tag=chancellor] minecraft:totem_of_undying{CustomModelData:0,policy:0,display:{Name:'{"translate":"syb.item.name.villager_policy"}',Lore:['{"translate":"syb.item.lore.villager_policy"}']}} 1
execute if score v_policies_inhand game_data matches 2 run give @a[tag=chancellor] minecraft:totem_of_undying{CustomModelData:0,policy:0,display:{Name:'{"translate":"syb.item.name.villager_policy"}',Lore:['{"translate":"syb.item.lore.villager_policy"}']}} 2
scoreboard players set v_policies_inhand game_data 0

execute if score i_policies_inhand game_data matches 1 run give @a[tag=chancellor] minecraft:totem_of_undying{CustomModelData:1,policy:1,display:{Name:'{"translate":"syb.item.name.illager_policy"}',Lore:['{"translate":"syb.item.lore.illager_policy"}']}} 1
execute if score i_policies_inhand game_data matches 2 run give @a[tag=chancellor] minecraft:totem_of_undying{CustomModelData:1,policy:1,display:{Name:'{"translate":"syb.item.name.illager_policy"}',Lore:['{"translate":"syb.item.lore.illager_policy"}']}} 2
