...
execute if score v_policies_inhand game_data matches 2 run replaceitem entity @a[tag=chancellor] hotbar.5 minecraft:totem_of_undying{CustomModelData:0,policy:0,display:{Name:'{"translate":"syb.item.name.villager_policy"}',Lore:['{"translate":"syb.item.lore.villager_policy"}']}} 2
...
execute if score i_policies_inhand game_data matches 2 run replaceitem entity @a[tag=chancellor] hotbar.3 minecraft:totem_of_undying{CustomModelData:1,policy:1,display:{Name:'{"translate":"syb.item.name.illager_policy"}',Lore:['{"translate":"syb.item.lore.illager_policy"}']}} 2
