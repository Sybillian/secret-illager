...
execute if score players game_data matches 5..6 if score policies_i game_data matches 3 run function syb:executive/trigger/init/scry
execute if score players game_data matches 5..6 if score policies_i game_data matches 4 run function syb:executive/trigger/init/elim_player
execute if score players game_data matches 5..6 if score policies_i game_data matches 5 run function syb:executive/trigger/init/elim_player
...
execute if score players game_data matches 7..8 if score policies_i game_data matches 2 run function syb:executive/trigger/init/investigate
execute if score players game_data matches 7..8 if score policies_i game_data matches 3 run function syb:executive/trigger/init/choose_pres
execute if score players game_data matches 7..8 if score policies_i game_data matches 4 run function syb:executive/trigger/init/elim_player
execute if score players game_data matches 7..8 if score policies_i game_data matches 5 run function syb:executive/trigger/init/elim_player
...
execute if score players game_data matches 9..10 if score policies_i game_data matches 1..2 run function syb:executive/trigger/init/investigate
execute if score players game_data matches 9..10 if score policies_i game_data matches 3 run function syb:executive/trigger/init/choose_pres
execute if score players game_data matches 9..10 if score policies_i game_data matches 4 run function syb:executive/trigger/init/elim_player
execute if score players game_data matches 9..10 if score policies_i game_data matches 5 run function syb:executive/trigger/init/elim_player
