...
execute if score 7 alive matches 1 run loot replace entity @s inventory.21 kill @a[scores={id=7},limit=1]
execute if score 8 alive matches 1 run loot replace entity @s inventory.22 kill @a[scores={id=8},limit=1]
execute if score 9 alive matches 1 run loot replace entity @s inventory.23 kill @a[scores={id=9},limit=1]
execute if score 7 alive matches 0 run replaceitem entity @s inventory.21 minecraft:barrier
execute if score 8 alive matches 0 run replaceitem entity @s inventory.22 minecraft:barrier
execute if score 9 alive matches 0 run replaceitem entity @s inventory.23 minecraft:barrier
