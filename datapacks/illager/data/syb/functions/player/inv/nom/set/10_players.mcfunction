...
replaceitem entity @s inventory.13 minecraft:carrot_on_a_stick{CustomModelData:0,display:{Name:'{"text":""}'}}
...
execute if score 8 alive matches 1 run loot replace entity @s inventory.21 kill @a[scores={id=9},limit=1]
execute if score 9 alive matches 1 run loot replace entity @s inventory.22 kill @a[scores={id=10},limit=1]
execute if score 10 alive matches 1 run loot replace entity @s inventory.23 kill @a[scores={id=11},limit=1]
execute if score 8 alive matches 0 run replaceitem entity @s inventory.21 minecraft:barrier
execute if score 9 alive matches 0 run replaceitem entity @s inventory.22 minecraft:barrier
execute if score 10 alive matches 0 run replaceitem entity @s inventory.23 minecraft:barrier
