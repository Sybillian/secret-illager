...
execute if score 4 alive matches 1 run loot replace entity @s inventory.11 kill @a[scores={id=4},limit=1]
execute if score 5 alive matches 1 run loot replace entity @s inventory.12 kill @a[scores={id=5},limit=1]
execute if score 6 alive matches 1 run loot replace entity @s inventory.13 kill @a[scores={id=6},limit=1]
execute if score 7 alive matches 1 run loot replace entity @s inventory.14 kill @a[scores={id=7},limit=1]
execute if score 8 alive matches 1 run loot replace entity @s inventory.15 kill @a[scores={id=8},limit=1]
execute if score 4 alive matches 0 run replaceitem entity @s inventory.11 minecraft:barrier
execute if score 5 alive matches 0 run replaceitem entity @s inventory.12 minecraft:barrier
execute if score 6 alive matches 0 run replaceitem entity @s inventory.13 minecraft:barrier
execute if score 7 alive matches 0 run replaceitem entity @s inventory.14 minecraft:barrier
execute if score 8 alive matches 0 run replaceitem entity @s inventory.15 minecraft:barrier
...
execute if score 9 alive matches 1 run loot replace entity @s inventory.21 kill @a[scores={id=9},limit=1]
execute if score 10 alive matches 1 run loot replace entity @s inventory.22 kill @a[scores={id=10},limit=1]
execute if score 11 alive matches 1 run loot replace entity @s inventory.23 kill @a[scores={id=11},limit=1]
execute if score 9 alive matches 0 run replaceitem entity @s inventory.21 minecraft:barrier
execute if score 10 alive matches 0 run replaceitem entity @s inventory.22 minecraft:barrier
execute if score 11 alive matches 0 run replaceitem entity @s inventory.23 minecraft:barrier
