...
replaceitem entity @s inventory.14 minecraft:carrot_on_a_stick{CustomModelData:0,display:{Name:'{"text":""}'}}
...
replaceitem entity @s inventory.22 minecraft:carrot_on_a_stick{CustomModelData:0,display:{Name:'{"text":""}'}}
