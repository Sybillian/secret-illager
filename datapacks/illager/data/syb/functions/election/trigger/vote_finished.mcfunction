...
execute as @a if score @s nom_vote matches 0 run tellraw @a [{"translate":"syb.chat.vote_result","with":[{"selector":"@s[scores={id=1..}]","color":"reset"},{"translate":"syb.generic.no","color":"red"}]}]
execute as @a if score @s nom_vote matches 1 run tellraw @a [{"translate":"syb.chat.vote_result","with":[{"selector":"@s[scores={id=1..}]","color":"reset"},{"translate":"syb.generic.yes","color":"green"}]}]
